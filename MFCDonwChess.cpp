...
BEGIN_MESSAGE_MAP(CMFCDonwChessApp, CWinApp)
...
CMFCDonwChessApp::CMFCDonwChessApp()
{
	// 支持重新启动管理器
...
// 唯一的 CMFCDonwChessApp 对象

CMFCDonwChessApp theApp;


// CMFCDonwChessApp 初始化

BOOL CMFCDonwChessApp::InitInstance()
{
